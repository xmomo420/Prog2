 ...
 */
public class ExempleReseauSocial_Approche3 {
   //Pour tests
   ...
   /**
    * Affiche les membres du reseau qui sont selectionnes par le testeur donne.
    * @param reseau la liste des membres
    * @param testeur la methode pour selectionnes un membre
    */
   ...
   public static void main (String[] args) {
      ...
      //Envoyer une expression lambda en parametre de la methode 
      //afficherMembresSelectionnes.

      //Notez que le type de m est infere du contexte.
      //Notez qu'on infere le type de m du contexte. Puisque le deuxieme parametre 
      //de la methode afficherMembresSelectionnes est de type ITesteurMembre, et que
      //la methode de cette interface prend un Membre en parametre, on infere que m 
      //est de type Membre. 
      ...
      //Creer une instance d'une expression lambda, et l'envoyer en parametre 
      //a la methode afficherMembresSelectionnes

      ITesteurMembre testeurGenre =  m -> m.getGenre() == 'f';
